<table style="width: 100%; border-spacing: 0px">
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid black;border-right: 1px solid black; padding: 5px;">{{ $data['nd_email'] }}</td>
    </tr>
    <tr>
        ...
        <td style="border-bottom: 1px solid black;border-right: 1px solid black; padding: 5px;">{!! $data['nd_hoten'] !!}</td>
    </tr>
    <tr>
        ...
        <form class="d-inline" method="post" action="{{ route('activate', ['nd_id' => $data['nd_id']]) }}">
            {{ csrf_field() }}
